...
// Text-only credit: no remote image, so the page works offline and makes no
// outbound request. Attribution lives in NOTICE.
function brandMarkup() {
  return '<div class="brand"><span class="brand-copy">Brainstorm Companion — derived from Superpowers (MIT)</span></div>';
}
